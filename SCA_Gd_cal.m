...
for k=0:1/180*pi:2*pi-1/180*pi
    ...
    for n_Gd=1:4 %Calculate scattered photons in different insertions
        ...
        isxf=L1<dm1; %Ignore path length sampled which is longer than Max path length in the insertion
    ...
    isxf=L1<dto; %Ignore path length sampled which is longer than Max path length in the phantom
...
%Save
save sca_Gd_90keV_double nsca1 nsca2
